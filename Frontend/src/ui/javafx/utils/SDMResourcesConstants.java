...
public class SDMResourcesConstants {
    ...
    private static final String ORDER_STORE_SUMMARY_FXML_RESOURCE_IDENTIFIER = BASE_PACKAGE + "/order/createOrder/steps/orderSummary/storeSummary/OrderStoreSummary.fxml";
    ...
    private static final String ORDER_SUMMARY_FXML_RESOURCE_IDENTIFIER = BASE_PACKAGE + "/order/createOrder/steps/orderSummary/OrderSummary.fxml";
    ...
    public static final URL ORDER_SUMMARY_FXML_RESOURCE = SDMResourcesConstants.class.getResource(ORDER_SUMMARY_FXML_RESOURCE_IDENTIFIER);
